...
{
     /// <summary>
    /// MongoClientProvider that subscribes for mongo events,
    /// and write additional dependency telemetry.
    /// </summary>
    [ExcludeFromCodeCoverage]
    public class PosProfileMongoClientProvider : IMongoClientProvider
    {
        private const string MongoDbDepencencyName = "MongoDB.PosProfile";

        private readonly TelemetryClient _telemetryClient;
        private MongoUrl _mongoUrl;

        public PosProfileMongoClientProvider(TelemetryClient telemetryClient) =>
