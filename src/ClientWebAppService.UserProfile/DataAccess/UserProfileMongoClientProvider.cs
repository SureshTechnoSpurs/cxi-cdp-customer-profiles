...
namespace ClientWebAppService.UserProfile.DataAccess
{
    ...
    public class UserProfileMongoClientProvider : IMongoClientProvider
    {
        private const string MongoDbDepencencyName = "MongoDB.UserProfile";

        private readonly TelemetryClient _telemetryClient;
        private MongoUrl _mongoUrl;

        public UserProfileMongoClientProvider(TelemetryClient telemetryClient) =>
