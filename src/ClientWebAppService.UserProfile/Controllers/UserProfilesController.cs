...
namespace ClientWebAppService.UserProfile.Controllers
{
    ...
    public class UserProfilesController : ControllerBase
    {
        ...
        [HttpPost("partner-feedback-message/{partnerId}")]
        [ProducesResponseType(typeof(PaginatedResponse<UserFeedbackMessageDto>), 200)]
        [ProducesResponseType(typeof(ValidationProblemResponse), 400)]
        public async Task<IActionResult> GetFeedbackMessage([CustomizeValidator(Skip = true)][FromRoute] string partnerId, [FromBody] PaginationRequest paginationRequest)
        {
